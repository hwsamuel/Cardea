...
var jbImagesDialog = {
	...
	uploadFinish : function(result) {
		...
		else
		{
			...
			tinyMCEPopup.editor.execCommand('mceInsertContent', false, '<a href="' + result.filename + '" data-lightbox="images"><img align="right" class="imguploads" src="' + result.filename +'" /></a>');
			tinyMCEPopup.close();
		}
	}
