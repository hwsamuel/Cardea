...
<div class="row">
    ...
    <div class="row" style="margin-top:-20px;">
        <div class="col-md-4">
            <h4>Patient to Patient <span class="badge">P2P</span></h4>
            <p class="text-justify">Share experiences with other patients while keeping track of privacy and credibility.</p>
            <p><a class="btn btn-black btn-warning" href="/cardea/patient-patient" role="button">Go to P2P Forum</a></p>
        </div>
        <div class="col-md-4">
            <h4>Patient to Medic <span class="badge">P2M</span></h4>
            <p class="text-justify">Post questions to medical professionals while maintaining confidentiality.</p>
            <p><a class="btn btn-black btn-warning" href="/cardea/patient-medic" role="button">Go to P2M Forum</a></p>
        </div>
        <div class="col-md-4">
            <h4>Medic to Medic <span class="badge">M2M</span></h4>
            <p class="text-justify">Medical professionals can share knowledge across geographical boundaries.</p>
            <p><a class="btn btn-black btn-warning" href="/cardea/medic-medic" role="button">Go to M2M Forum</a></p>
        </div>
    </div>
    </div>
    </div>
